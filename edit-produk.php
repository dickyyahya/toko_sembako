...
<head>
    ...
    <script src="https://cdn.tiny.cloud/1/dzi0teorvmv558s2nke54lp71p44v595qmca41zx4pvf1p0r/tinymce/6/tinymce.min.js"></script>
</head>
        ...
        <div class="container">
            ...
            <div class="box">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <textarea class="input-control" name="deskripsi" placeholder="Deskripsi" id="deskripsi"><?php echo $p->product_description ?></textarea>
