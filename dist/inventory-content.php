    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div class="">
                    <h1 class="fs-3 mb-1">Data Produk</h1>
                </div>
                <div>
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr class="align-middle ">
                                    <td><?php echo $no++ ?></td>
                                    <td><a href=""><img src="../produk/<?php echo $row['product_image'] ?>" alt="" class="avatar avatar-md rounded" /><span class="ms-3"><?php echo $row['product_name'] ?></span></a>
                                    </td>
